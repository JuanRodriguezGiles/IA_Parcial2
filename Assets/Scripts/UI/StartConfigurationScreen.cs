...
public class StartConfigurationScreen : MonoBehaviour
{
    ...
    {   
        ...
        generationDurationSlider.value = PopulationManager.Instance.TurnDuration;
    ...
    {
        PopulationManager.Instance.TurnDuration = (int)value;
        
        generationDurationTxt.text = string.Format(generationDurationText, PopulationManager.Instance.TurnDuration);
    }
